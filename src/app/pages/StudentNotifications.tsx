    ...
    <div className="space-y-8 animate-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 font-medium text-sm">Retrouvez toutes les mises à jour sur votre parcours.</p>
        </div>
      ...
      {notifications.length > 0 ? (
        ...
        <Card className="border-0 shadow-sm rounded-[2.5rem]">
          <CardContent className="p-20 text-center">
            ...
            <h3 className="text-xl font-black text-gray-900 tracking-tighter mb-2">Aucune nouvelle</h3>
            <p className="text-gray-500 font-medium">Revenez plus tard pour vos notifications.</p>
          </CardContent>
        </Card>
      )}
    </div>
