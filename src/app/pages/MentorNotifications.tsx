    ...
    <div className="space-y-8 animate-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 font-medium text-sm">Restez informé de l'activité sur les projets que vous encadrez.</p>
        </div>
      ...
      {notifications.length > 0 ? (
        ...
        <Card className="border-0 shadow-sm rounded-[2.5rem]">
          <CardContent className="p-20 text-center">
            ...
            <h3 className="text-xl font-black text-gray-900 tracking-tighter mb-2">Aucune notification</h3>
            <p className="text-gray-500 font-medium">Vous serez notifié dès qu'il y aura du nouveau sur vos projets assignés.</p>
          </CardContent>
        </Card>
      )}
    </div>
